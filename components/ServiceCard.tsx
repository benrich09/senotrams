...
export default function ServiceCard({ service }: { service: ServiceItem }) {
  ...
  return (
    <article className="group relative flex h-full min-h-[260px] flex-col overflow-hidden rounded-[1.75rem] border border-line-light bg-paper p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-orange/40 hover:shadow-lg">
      <div
      ...
      <Link
        ...
        className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-orange transition-colors hover:underline underline-offset-4"
      >
        Learn more
