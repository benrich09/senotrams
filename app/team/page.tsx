    ...
    <div className="bg-paper">
      ...
      <section className="px-6 py-20 md:px-10 md:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {founders.map((f) => (
              <div key={f.name} className="flex items-center gap-5 rounded-3xl border border-line bg-white p-7">
      ...
      <section className="border-y border-line-light bg-paper-2 px-6 py-20 md:px-10 md:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <h2 className="mt-4 font-display text-3xl font-bold text-ink sm:text-4xl">The wider team</h2>
          {/* TODO: fill in real team members — left as open slots */}
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {teamMembers.map((m, i) => (
              <div
                key={i}
                className="placeholder-frame flex flex-col items-center gap-4 rounded-3xl border border-dashed border-line-light bg-white p-6 text-center"
              >
