...
export const metadata: Metadata = {
  ...
  description: "Meet the team behind Senotrams.",
};
  ...
  return (
    <div className="bg-paper">
      <PageHero
        ...
        description="The team driving Senotrams forward."
      />
      ...
      <section className="px-6 py-16 md:px-10 md:py-24">
        <div className="mx-auto grid max-w-6xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {team.map((m) => (
            <article
              key={m.name}
              className="flex min-h-[280px] flex-col rounded-[1.75rem] border border-line-light bg-paper-2 p-6"
            >
              ...
              <p className="mt-6 text-xs font-semibold uppercase tracking-wide text-orange">
                {m.role}
              </p>
